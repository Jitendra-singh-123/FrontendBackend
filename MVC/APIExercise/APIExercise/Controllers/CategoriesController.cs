...
namespace APIExercise.Controllers
{
    ...
    {
        private readonly APIExerciseDbContext _context;

        public CategoriesController(APIExerciseDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Category>> PostCategory(Category category)
        {
          if (_context.Categories == null)
          {
              return Problem("Entity set 'APIExerciseDbContext.Categories'  is null.");
          }
