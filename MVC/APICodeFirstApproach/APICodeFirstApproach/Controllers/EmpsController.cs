...
namespace APICodeFirstApproach.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmpsController : ControllerBase
    {
        private readonly APICodeFirstApproachContext _context;

        public EmpsController(APICodeFirstApproachContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Emp>> PostEmp(Emp emp)
        {
          if (_context.Emp == null)
          {
              return Problem("Entity set 'APICodeFirstApproachContext.Emp'  is null.");
          }
