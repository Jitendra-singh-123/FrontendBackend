...
using DataBaseFirstApproachBookContext.Models;

namespace DataBaseFirstApproachBook.Controllers
{
    public class BooksTablesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BooksTables != null ? 
                          ...
                          Problem("Entity set 'DatabaseFirstApproachContext.BooksTables'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Author")] BooksTable booksTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Author")] BooksTable booksTable)
        {
            if (id != booksTable.Id)
            {
                return NotFound();
