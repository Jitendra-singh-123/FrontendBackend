...
namespace CarRentalSystemProject.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(CarRentalSystemProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Manufacturer != null ? 
                          ...
                          Problem("Entity set 'CarRentalSystemProjectContext.Manufacturer'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CarRentalSystemProjectContext.Manufacturer'  is null.");
            }
            var manufacturer = await _context.Manufacturer.FindAsync(id);
            if (manufacturer != null)
            {
