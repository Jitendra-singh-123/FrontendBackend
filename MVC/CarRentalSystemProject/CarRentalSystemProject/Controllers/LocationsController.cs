...
namespace CarRentalSystemProject.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(CarRentalSystemProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Location != null ? 
                          ...
                          Problem("Entity set 'CarRentalSystemProjectContext.Location'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CarRentalSystemProjectContext.Location'  is null.");
            }
            var location = await _context.Location.FindAsync(id);
            if (location != null)
            {
