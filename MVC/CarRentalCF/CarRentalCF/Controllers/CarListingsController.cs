...
namespace CarRentalCF.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarListingsController : ControllerBase
    {
        private readonly CarRentalCFContext _context;

        public CarListingsController(CarRentalCFContext context)
        {
            _context = context;
        }
        ...
        // GET: api/CarListings
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CarListing>>> GetCarListing()
        {
          if (_context.CarListing == null)
          {
              return NotFound();
          }
            return await _context.CarListing.ToListAsync();
        }
        ...
        public async Task<ActionResult<CarListing>> GetCarListing(int id)
        {
          if (_context.CarListing == null)
          {
            ...
            var carListing = await _context.CarListing.FindAsync(id);
        ...
        public async Task<ActionResult<CarListing>> PostCarListing(CarListing carListing)
        {
          if (_context.CarListing == null)
          {
              return Problem("Entity set 'CarRentalCFContext.CarListing'  is null.");
          }
        ...
        public async Task<IActionResult> DeleteCarListing(int id)
        {
            ...
            _context.CarListing.Remove(carListing);
            await _context.SaveChangesAsync();
        ...
        {
            return (_context.CarListing?.Any(e => e.CarId == id)).GetValueOrDefault();
        }
    }
}
